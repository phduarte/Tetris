...
namespace Gadz.Tetris.Model {
    ...
    public class Tabuleiro {
        ...
        public Peca ProximaPeca { get; private set; }
        ...
        public event GameActionEventHandler QuandoAtualizar;
        public event GameActionEventHandler QuandoTerminar;
        public event GameActionEventHandler QuandoLimpar;
        public event GameActionEventHandler QuandoMover;
        public event GameActionEventHandler QuandoDeslizar;
        ...
        public void Rotacionar() {
            ...
            if (!Estado.PodeMovimentarBloco || ExisteColisao(PecaAtual)) {
                return;
            }
        ...
        bool PodeMoverParaEsquerda(Peca peca) {
        ...
        bool PodeMoverParaDireita(Peca peca) {
        ...
        bool PodeMoverPraBaixo(Peca peca) {
        ...
        void MoverBlocosParaBaixo(int linha) {
            for (var i = 0; i < _blocosJogados.Count; i++) {
